Long simulation, compressible, composite power-law rheology
...
`displacement-weerdesteijn-3d-iv-burgersFalse-gmd-refinedsurfaceTrue-dx5.0km-nz10perlayer-dt1000.0years-bulk1.94-powerTrue-nondim.dat`
...
`> python3 3d_weerdesteijn_coupled.py --power_law --transition_stress 0.2 --refined_surface --dx 5 --DG0_layers 10 --dt_years 1000 --bulk_shear_ratio 1.94 --Tend 110e3 --dt_out_years 10e3 --output_path /path/to/output/`
