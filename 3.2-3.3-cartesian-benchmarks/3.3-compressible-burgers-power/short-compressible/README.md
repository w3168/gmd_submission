...
`displacement-weerdesteijn-3d-iv-burgersFalse-gmd-refinedsurfaceTrue-dx5.0km-nz10perlayer-dt10.0years-bulk1.94-nondim.dat`

To run the case use the `3d_weerdesteijn.py` script from the parent directory
 `gmd_submission/3.2-3.3-cartesian-benchmarks`

`> python3 3d_weerdesteijn.py --short_simulation --refined_surface --dx 5 --DG0_layers 10 --dt_years 10 --bulk_shear_ratio 1.94 --Tend 200 --dt_out_years 50 --output_path /path/to/output/`
