...
`displacement-weerdesteijn-3d-iv-burgersFalse-gmd-refinedsurfaceTrue-dx5.0km-nz10perlayer-dt1000.0years-bulk1.94-nondim.dat`

To run the case use the `3d_weerdesteijn.py` script from the parent directory
 `gmd_submission/3.2-3.3-cartesian-benchmarks`

`> python3 3d_weerdesteijn.py --refined_surface --dx 5 --DG0_layers 10 --dt_years 1000 --bulk_shear_ratio 1.94 --Tend 110e3 --dt_out_years 10e3 --output_path /path/to/output/`
