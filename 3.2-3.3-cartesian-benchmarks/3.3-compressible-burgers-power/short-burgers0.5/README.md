Short simulation, compressible, Burgers rheology (viscosity 2 / viscosity 1 = 0.5)
...
`> python3 3d_weerdesteijn.py --burgers --viscosity_ratio 0.5 --short_simulation --refined_surface --dx 5 --DG0_layers 10 --dt_years 10 --bulk_shear_ratio 1.94 --Tend 200 --dt_out_years 50 --output_path /path/to/output/`
