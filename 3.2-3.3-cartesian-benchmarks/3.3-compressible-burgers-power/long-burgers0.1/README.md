Long simulation, compressible, Burgers rheology (viscosity 2 / viscosity 1 = 0.1)
...
`> python3 3d_weerdesteijn.py --burgers --viscosity_ratio 0.1 --refined_surface --dx 5 --DG0_layers 10 --dt_years 1000 --bulk_shear_ratio 1.94 --Tend 110e3 --dt_out_years 10e3 --output_path /path/to/output/`
