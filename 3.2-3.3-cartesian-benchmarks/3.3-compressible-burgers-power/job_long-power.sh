...
output_path="/g/data/xd2/ws9229/gmd_submission/3.2-3.3-cartesian-benchmarks/3.3-compressible-burgers-power/long-power/"

mpiexec -np ${PBS_NCPUS} python3 3d_weerdesteijn_coupled.py --power_law --transition_stress $trans_stress --dx $dx --refined_surface --DG0_layers $dglayers --dt_years $dt --bulk_shear_ratio $bulk_shear_ratio --Tend $Tend --dt_out_years $dt_out --output_path $output_path --optional_name "gmd" &> 11.03.26_weerdesteijn_internalvariable_110kyr_dt${dt}yr_dtout10kyr_normalsr${PBS_NCPUS}cores_mem4000gb_dx${dx}to200km_refinedsurface_DG0nzperlayer${dglayers}_icetanh1km_bulktoshear${bulk_shear_ratio}_power_transitionstress${trans_stress}
