...
`> python3 3d_weerdesteijn_coupled.py --lateral_viscosity --refined_surface --dx 5 --DG0_layers 10 --dt_years 1000 --bulk_shear_ratio 1000 --Tend 110e3 --dt_out_years 10e3 --output_path /path/to/output/`
